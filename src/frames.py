...
class GPR_AND_IXR(ttk.Frame):
    def __init__(self, master):
        ...
        gpr0 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        gpr1 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        gpr2 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        gpr3 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        ixr1 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        ixr2 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        ixr3 = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
...
class OTHER_MACHINE_REGISTERS(ttk.Frame):
    def __init__(self, master):
        ...
        pc = tk.Text(self, width="24", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        mar = tk.Text(self, width="24", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        mbr = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        ir = tk.Text(self, width="32", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        ...
        mfr = tk.Text(self, width="8", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
        mfr.configure(state='disabled')
        mfr.grid(column=1, row=4, padx="10", sticky="w")

        # cc
        tk.Label(self, text="CC").grid(column=0, row=5, sticky="w")
        cc = tk.Text(self, width="4", height="1", padx=2, borderwidth=2, relief=tk.SUNKEN)
...
class FUNCTION_BUTTONS(ttk.Frame):
    def __init__(self, master):
        ...
        tk.Canvas(halt_frame, bg="black", height="20",width="20").grid(column=1, row=0)

        run_frame = ttk.Frame(self, padding=5)
        tk.Label(run_frame, text="Run").grid(column=0, row=0)
        tk.Canvas(run_frame, bg="black", height="20", width="20").grid(column=1, row=0)
